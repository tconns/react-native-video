...
class VideoEventEmitter {
    ...
    private static final String EVENT_SHOW_PEER = "onShowPeer";
    ...
    private static final String EVENT_PROP_SHOW_PEER = "dataPeer";
    ...
    void showPeer(String dataPeer){
        WritableMap event = Arguments.createMap();
        event.putString(EVENT_PROP_SHOW_PEER, dataPeer);
        receiveEvent(EVENT_SHOW_PEER, event);
    }
