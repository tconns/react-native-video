...
export default class Video extends Component {
  ...
  _showPeer = event =>{
    if (this.props.onShowPeer) {
      this.props.onShowPeer(event.nativeEvent);
    }
  }
...
Video.propTypes = {
  /* Native only */
  usePeer: PropTypes.bool,
  onShowPeer: PropTypes.func,
  ...
  selectedVideoTrack:PropTypes.number,
  selectedAudioTrack:PropTypes.number,
  selectedTextTrack:PropTypes.number,
